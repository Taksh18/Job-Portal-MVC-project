...
<body class="home">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/223032510_352649179598831_4223889763462222005_n-removebg-preview.png" alt="Logo" /></a>
						</div>
					</div>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<p>Finding your next job or career on JobHunt</p>
    ...
    <select class="form-control" name="country" required>
        ...
        try {
            ...
            // Fetch only Auckland, Hamilton, and Wellington
            $stmt = $conn->prepare("SELECT country_name FROM tbl_countries WHERE country_name IN ('Auckland', 'Hamilton', 'Wellington') ORDER BY country_name");
            $stmt->execute();
            $result = $stmt->fetchAll();

            // Debug: Check if results were fetched
            if (empty($result)) {
                echo "<!-- No matching records found -->";
            }

            // Loop through and display only selected states
            foreach ($result as $row) {
                echo '<option style="color:black" value="' . htmlspecialchars($row['country_name']) . '">' . htmlspecialchars($row['country_name']) . '</option>';
            }
        } catch (PDOException $e) {
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About JobHunt</h5>
											<p>JobHunt is a job portal, online job management system developed by Takshkumar Patel for his project in february 2025.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title"> JobHunt Contact</h5>
								
								<p>Address : Takoradi, School Junction PO.BOX AX40</p>
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">JobHunt.nath2@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> JobHunt Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by TakshKumar Patel</a></li>
								</ul>
